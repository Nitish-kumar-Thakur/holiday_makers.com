...
class Curisespackage extends StatefulWidget {
  const Curisespackage({super.key});

  @override
  State<Curisespackage> createState() => _CurisespackageState();
}

class _CurisespackageState extends State<Curisespackage> {
