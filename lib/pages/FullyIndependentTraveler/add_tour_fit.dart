...
class _TourBookingPageFITState extends State<TourBookingPageFIT> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchFITTourList() async {
    try {
      ...
      final response = await APIHandler.getFITTourList(widget.searchId ?? "");
      setState(() {
        allTours = List<Map<String, dynamic>>.from(response['data']['activity'] ?? []);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    (tourForDay['totalmembers'] == null || tourForDay['totalmembers'] == 0 ||
                                        tourForDay['Per_totalAmount'] == null || tourForDay['Per_totalAmount'] == 0)
