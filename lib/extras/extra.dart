...
//   const PaymentScreen({super.key, required this.BSData, required this.sbAPIBody});
...
//     paymentMethods = widget.BSData['payment_options'] ?? widget.BSData['data']['payment_options'];
//   }
...
//         context,
//         MaterialPageRoute(
//           builder: (context) => PaymentWebView(paymentUrl: checkoutUrl.toString(), paymentMethod: paymentMethod),
//         ),
//       );
//       // print('###############################################');
//       // print(paymentMethod);
...
//       // print('###############################################');
//       if (paymentMethod == "telr" && result == "success") {
...
//                           startPayment(paymentMethod['payment_type'] ?? "");
//                         },
//                       ),
//                     ),
//                   ),
